...
@REM D:\VulkanSDK\1.3.268.0\Bin\dxc.exe -spirv -T vs_6_1 -E main Assets\Shaders\transparent_vert.hlsl -Fo Assets\Shaders\spv\transparent_vert.hlsl.spv
@REM D:\VulkanSDK\1.3.268.0\Bin\dxc.exe -spirv -T ps_6_1 -E main Assets\Shaders\transparent_frag.hlsl -Fo Assets\Shaders\spv\transparent_frag.hlsl.spv