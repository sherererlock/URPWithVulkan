...
namespace vkglTF
{
	enum DescriptorBindingFlags {
		...
		ImageMetalRoughnessMap = 0x00000004,
	...
	*/
	struct Texture {
		...
		void destroy();
		void fromglTfImage(tinygltf::Image& gltfimage, std::string path, ShDevice* device, VkQueue copyQueue);
	};
	...
	*/
	struct Material {
		...
		Material(ShDevice* device) : device(device) {};
	...
	*/
	...
	public:
		...
		void loadImages(tinygltf::Model& gltfModel, ShDevice* device, VkQueue transferQueue);
