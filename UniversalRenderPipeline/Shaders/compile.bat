...
glslangValidator.exe -V Shaders\gbuffer_skin.vert -o Shaders\spv\gbuffer_skin.vert.spv
...
@REM D:\VulkanSDK\1.3.268.0\Bin\dxc.exe -spirv -T ps_6_1 -E main Shaders\Lighting_frag.hlsl -Fo Shaders\spv\Lighting_frag.hlsl.spv